...
parser = argparse.ArgumentParser(
    description='Compute a voxel grid from images (3 color coefficients per voxel)')
...
plt.imsave('screenshots/render.png',
           VG.render_large_image_from_rays(rays[30], (N_points, 1.2)))
plt.show()

print('Coloring model')
color(VG, train_loader, N_points)
plt.imsave('screenshots/render2.png',
           VG.render_large_image_from_rays(rays[30], (N_points, 1.2)))
plt.show()
